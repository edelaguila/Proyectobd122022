...
public class daoUsuario {
    ...
    private static final String SQL_QUERYN = "SELECT usuid, usunombre, usucontrasena, usuestatus, usunombrereal, usucorreoe, usutelefono, usudireccion, Tipo FROM tbl_usuario WHERE usunombre=?";    
