...
public class clsCompradores {
    ...
    public clsCompradores() {
    }

    public clsCompradores(int iId_vendedor) {
    this.iId_vendedor = iId_vendedor;
    }

     public clsCompradores(String sNombre, String sDireccion, String sCorreo, String sEstado, String sTipo, int iId_vendedor,  int iTelefono) {
        this.iId_vendedor = iId_vendedor;
